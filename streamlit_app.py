...
st.markdown(
    ...
    .brand-mark {
        ...
        height: 36px;
        border-radius: 10px;
        background: linear-gradient(145deg, #E11D3A, #9B0C22);
        display: flex;
        align-items: center;
...
def render_page_header(title: str, subtitle: str) -> None:
    st.markdown(
        ...
        <div class="page-header">
            <div class="page-badge">Live Auction Intelligence</div>
...
def render_top_bar(title: str) -> None:
    st.markdown(
        ...
        <div class="top-bar">
            ...
            <div class="format-chip">Format: NPL Auction</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
...
if page == "Data Overview":
    render_top_bar("Data Overview")
    st.markdown('<div class="main-panel">', unsafe_allow_html=True)
    render_page_header("Auction Overview", "A sharper view of the talent pool and the current market signals.")
    ...
    render_top_bar("ML Predictions")
    st.markdown('<div class="main-panel">', unsafe_allow_html=True)
    render_page_header("Prediction Studio", "Estimate market value for known players and simulate new auction profiles.")
    ...
    render_top_bar("Player Comparison")
    st.markdown('<div class="main-panel">', unsafe_allow_html=True)
    ...
    render_top_bar("Market Insights")
    st.markdown('<div class="main-panel">', unsafe_allow_html=True)
    render_page_header("Market Insights", "Discover the leading performers and the most promising auction picks.")
